...
const StateDistrictDropdown: React.FC<StateDistrictDropdownProps> = ({ onSelectState }) => {
    ...
    const handleStateChange = (event: ChangeEvent<HTMLSelectElement>) => {
        ...
        const selectedStateData = states.find(stateData => stateData.state === selectedState);
    ...
    return (
        <div>
            <div>
                ...
                <select id="state" className='ml-2 pl-3 border w-40 focus:outline-blue-gray-300 text-center' value={selectedState} onChange={handleStateChange}>
